...
from UsuariosApp.views import  login, registro, logout, perfil, editar_perfil, add_comercio, editar_comercio,eliminar_comercio, add_productos, eliminar_producto
